...
function parseProducts(json) {
   ...
   let data = JSON.parse(json); // Преобразуйте строку json, переданную как аргумент функ, в объект с помощью функции JSON.parse(json) и запишите в переменную data
    return products = data.products;     // Верните как результат функции свойство products объекта data
}
